...
from .views import index,custom_logout,activate,activateEmail,garage,carworkshop,Upgrade,Money_Up_View,Monay_Up_Payment,Drag_Racing,Drag_Racing_Payment
